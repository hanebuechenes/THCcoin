...
Alternatively, install Qt Creator and open the `thccoin-qt.pro` file.

An executable named `thccoin-qt` will be built.
...
installed causes thccoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
